...
*/
		...
		forwardText         : "Следующие", // Link text used to move the slider forward (hidden by CSS, replaced with arrow image)
		backText            : "Предыдущие", // Link text used to move the slider back (hidden by CSS, replace with arrow image)
